...
const nextConfig = {
  ...
  allowedDevOrigins: ['127.0.0.1', 'localhost', '*.replit.dev', '*.replit.co', '*.spock.replit.dev', '*.picard.replit.dev', '*.worf.replit.dev', '*.kirk.replit.dev', '*.sisko.replit.dev', '*.wesley.replit.dev', '*.data.replit.dev'],
  eslint: {
